...
library(flexmix) 
library(foreach)
df <- read_excel("C:/Users/Qubix/Desktop/R Sources/Copy of 2016 Final Grades II.xlsx");
...
write.xlsx(x = KL_comp_results, file = "output/KLDivResults.xlsx", row.names = FALSE); # Write the data.
